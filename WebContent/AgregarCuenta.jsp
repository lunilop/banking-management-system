        ...
        <div class="parteDer"> 
            ...
            <form action="servletAgregarCuentas" method="get">		    
                ...
                <div class="form-group">
                    ...
                    <select name="ddlTipoCuenta" required>
                        <option>Seleccione un Tipo de cuenta</option>
                        <% 
                            ArrayList<TipoCuentas> tiposCuentas = (ArrayList<TipoCuentas>) request.getAttribute("tiposCuentas");
                            for (TipoCuentas tipo : tiposCuentas) {
                        %>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name ="txtNroCuenta" required>
                </div><br>
