...
<div class="columna">
    <label class="label-agregar">Buscar por DNI:</label> <input type="text" name="txtBuscarDni">
    <input class="btnFiltrar" type="submit" name="btnBuscarDni" value="Filtrar" style="width: 120px; height: 50px">
</div> 
	<div class="columna">
    <input class="btnMostrar" type="submit" name="btnMostrarTodo" value="Mostrar Todo" style="width: 120px; height: 50px">
    </div> 
</div>  
</form><br>
<% 
        ...
        <% if (listaClientes != null) {
            for (Clientes cliente : listaClientes) { %>
                <tr>   
                        ...
                        <td  style="width: 140px;"><%= cliente.getDireccion() %></td>
