    ...
    <div class="parteDer">
        ...
        <div class="info-columns">
	        <div class="columna">
		            ...
		            <select name="ddlProvincia" style="width: 248px;">
            ...
            <tbody>
                <% if (listaClientes != null) {
       			...
       			<form action="ServletListarCliente?idFila=<%= filaId %>" method="post">
                            ...
                            <td data-order="<%= cliente.getUsuario() %>"><input type="text" name="txtUsuario" value="<%= cliente.getUsuario() %>"required></td>
                            <!--<td data-order="<%= cliente.getContraseña()%>"><input type="text" name="txtContrasenia" value="<%= cliente.getContraseña()%>"required></td>  -->
